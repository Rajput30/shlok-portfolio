...
const TIMELINE_DATA = [
  ...
  },
  {
    ...
    school: "DSEU Okhla-I — 1st Year",
    desc: "Elected as Class Representative in the first year — managing communication between students and faculty, organizing events.",
    accent: "#ffd700",
    icon: "★",
  },
  {
  ...
  return (
    <section id="hero" style={{
      ...
      <video ref={bgRef} autoPlay muted loop playsInline style={{
        ...
        <source src="/829450493_1780924077372397.mp4" type="video/mp4" />
      </video>
